...
void    TA2GoAT::PostInit()
{
    ...
    treeMWPCHits        = new TTree("MWPCHits",           "MWPCHits");
	...
	treeMWPCHits->Branch("nChamberHitsin1", &nChamberHitsin1, "nChamberHitsin1/I");
	treeMWPCHits->Branch("Chamber1X", Chamber1X, "Chamber1X[nChamberHitsin1]/D");
	treeMWPCHits->Branch("Chamber1Y", Chamber1Y, "Chamber1Y[nChamberHitsin1]/D");
	treeMWPCHits->Branch("Chamber1Z", Chamber1Z, "Chamber1Z[nChamberHitsin1]/D");

	treeMWPCHits->Branch("nChamberHitsin2", &nChamberHitsin2, "nChamberHitsin2/I");
	treeMWPCHits->Branch("Chamber2X", Chamber2X, "Chamber2X[nChamberHitsin2]/D");
	treeMWPCHits->Branch("Chamber2Y", Chamber2Y, "Chamber2Y[nChamberHitsin2]/D");
	treeMWPCHits->Branch("Chamber2Z", Chamber2Z, "Chamber2Z[nChamberHitsin2]/D");
    }
    if(fBaF2PWO)
    {
...
void    TA2GoAT::Reconstruct()
{
    ...
    if(treeMWPCHits)	treeMWPCHits->Fill();
